...
olentzero = Panpin("Olentzero", keys.OLENTZERO_PARSE_PATH, keys.OLENTZERO_TEXTU_FITXATEGIA, keys.OLENTZERO_AUDIO_FITXATEGIA,keys.OLENTZERO_AHOKO_GPIO_PINA,keys.OLENTZERO_FOLDER)
maridomingi = Panpin("Maridomingi", keys.MARIDOMINGI_PARSE_PATH, keys.MARIDOMINGI_TEXTU_FITXATEGIA,keys.MARIDOMINGI_AUDIO_FITXATEGIA,keys.MARIDOMINGI_AHOKO_GPIO_PINA,keys.MARIDOMINGI_FOLDER)
